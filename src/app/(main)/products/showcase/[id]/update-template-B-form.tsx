...
const UpdateTemplateBForm: FC<{
  ...
  useEffect(() => {
    ...
    form.setValue("title2", content.title2);
    form.setValue("description2", content.description2);
    form.setValue("template_image2", content.template_image2);

    setImageBase64([
      content.template_image0,
      content.template_image1,
      content.template_image2,
    ]);
  }, [content]);
  ...
  function onSubmit(values: CreateShowCaseType) {
    ...
    const template_image2 =
      typeof values.template_image2 === "string"
        ? values.template_image2
        : {
...
export default UpdateTemplateBForm;
