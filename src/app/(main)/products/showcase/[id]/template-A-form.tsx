  ...
  return (
    <Form {...form}>
      <form
        ...
        className="mx-auto flex h-full w-full max-w-5xl bg-white flex-col gap-6 md:rounded-lg border-y-1 max-md:border-slate-300 md:border-1 p-9 shadow-sm"
      >
...
export default ShowcaseTemplateA;
